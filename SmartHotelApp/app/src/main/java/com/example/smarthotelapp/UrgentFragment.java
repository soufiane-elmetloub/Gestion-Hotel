...
public class UrgentFragment extends Fragment {
    ...
    private void loadReports() {
        ...
        if (employeeId <= 0) {
            addInfoText("No employee selected.");
            return;
        }

        String url = NetworkConfig.getBaseUrlWithSlash() + "backend/get_reports.php?employee_id=" + employeeId + "&priority=urgent";
    ...
    private void addReportCard(JSONObject obj) {
        ...
        String priority = obj.optString("priority", "urgent");
        ...
        // Style badge for urgent
        badge.setText("🔴 URGENT");
        badge.setTextColor(0xFFD32F2F);
        badge.setBackgroundColor(0xFFFFE5E5);
