...
public class MediumFragment extends Fragment {
    ...
    private void loadReports() {
        ...
        String url = NetworkConfig.getBaseUrlWithSlash() + "backend/get_reports.php?employee_id=" + employeeId + "&priority=medium";
    ...
    private void addReportCard(JSONObject obj) {
        ...
        // Style badge for medium
        badge.setText("🟡 MEDIUM");
        badge.setTextColor(0xFFFF8F00);
